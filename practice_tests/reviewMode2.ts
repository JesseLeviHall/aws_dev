...
Take note that in this scenario, it is still using the same partition key (ForumName), but with an alternate sort key (LastPostDateTime) which warrants the use of a local secondary index.
